// Punt 2 : Creo Objecte alumne
const alumne = { nom: "David", cognom: "Castello", edat: 49 };
console.log(alumne);

// Punt 3 : Estructura de control
let valors = Object.values(alumne);
for (let i = 0; i < valors.length; i++) {
  console.log(valors[i]);
}
...
// Mostrar
let mostrarAlumne = alumnes[0].fullName();
console.log(mostrarAlumne);

// Borrar
// Nota: Es pot fer servir delete o pop(). delete NO borra
// l'espai a l'array. pop() si que ho fa
delete alumnes[2];
console.log(alumnes);
